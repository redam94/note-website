...
async def api_get_neighbors(
    ...
    return await get_neighbors(db, note_id, direction=direction, relationship=relationship)
...
async def api_bfs_traverse(
    ...
    return await bfs_traverse(db, note_id, max_depth=depth, max_nodes=max_nodes, relationship=relationship)
...
async def api_find_path(
    ...
    return await find_path(db, from_id, to_id, max_depth=max_depth)
...
async def api_get_context(
    ...
    return await get_note_context(db, note_id)
...
async def api_find_by_tag(
    ...
    """Find notes by tag."""
    return await find_by_tag(db, tag, limit=limit)
...
async def api_grep(
    ...
    return await grep_notes(db, q, case_sensitive=case_sensitive, limit=limit)
...
async def api_regex_search(
    ...
    return await regex_search(db, pattern, limit=limit)
...
async def api_find_related(
    ...
    return await find_related(db, note_id, limit=limit)
